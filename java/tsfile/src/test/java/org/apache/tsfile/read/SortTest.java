...
import org.apache.tsfile.utils.UnsortedFileGenerator;
...
public class SortTest {
    ...
    private static final String fileName = UnsortedFileGenerator.outputDataFile;
    ...
    public void prepare() throws IOException {
        UnsortedFileGenerator.generateFile(100, 100);
        ...
        times = UnsortedFileGenerator.getTimes();
        values = UnsortedFileGenerator.getValues();
    }
    ...
    public void sortOneMeasurementWithoutFilterTest() throws IOException {
        ...
        pathList2.add(new Path("d1", "s1", true));
        QueryExpression queryExpression2 = QueryExpression.create(pathList2, null);
        QueryDataSet dataSet = roTsFile.query(queryExpression2);
        ...
        while (dataSet.hasNext()) {
            ...
            assertEquals(r.getTimestamp(), times[count]);
            count++;
        }
        System.out.println(count);
    }
